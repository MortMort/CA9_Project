...
fcp.fatd.KpTwrPos = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_KpTwrPos');
fcp.fatd.KpTwrSpd = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_KpTwrSpd');

% Pos gain sch
fcp.fatd.GainSchWind.Wind1 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_WindSpd_1');
fcp.fatd.GainSchWind.Wind2 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_WindSpd_2');
fcp.fatd.GainSchWind.Wind3 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_WindSpd_3');
fcp.fatd.GainSchWind.Wind4 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_WindSpd_4');
fcp.fatd.GainSchWind.Gain1 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_Gain_1');
fcp.fatd.GainSchWind.Gain2 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_Gain_2');
fcp.fatd.GainSchWind.Gain3 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_Gain_3');
fcp.fatd.GainSchWind.Gain4 = ProdNormal_parm.getParamExactValue('Px_FATD_Pitch_GS_Gain_4');

% Vel gain sch
fcp.fatd.GainSchFreq.SwitchOffVelFb = ProdNormal_parm.getParamExactValue('Px_FATD_TowFrq_SwitchOffVelFb');
fcp.fatd.GainSchFreq.SwitchOnVelFb = ProdNormal_parm.getParamExactValue('Px_FATD_TowFrq_SwitchOnVelFb');
fcp.fatd.GainSchFreq.MinVelFbGain = ProdNormal_parm.getParamExactValue('Px_FATD_TowFrq_MinVelFbGain');
...
fcp.hwo.wind = zeros(1,6);
fcp.hwo.wind(1,1) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_RatedRef'); 
fcp.hwo.wind(1,2) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_01'); 
fcp.hwo.wind(1,3) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_02'); 
fcp.hwo.wind(1,4) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_03'); 
fcp.hwo.wind(1,5) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_04'); 
fcp.hwo.wind(1,6) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_WindSpd_05'); 

fcp.hwo.genSpd = zeros(1,6);
fcp.hwo.genSpd(1,1) = ProdNormal_parm.getParamExactValue('Px_LDO_GenSpdSetpoint'); 
fcp.hwo.genSpd(1,2) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_GenSpd_01'); 
fcp.hwo.genSpd(1,3) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_GenSpd_02'); 
fcp.hwo.genSpd(1,4) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_GenSpd_03'); 
fcp.hwo.genSpd(1,5) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_GenSpd_04'); 
fcp.hwo.genSpd(1,6) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_GenSpd_05'); 

fcp.hwo.power = zeros(1,6);
fcp.hwo.power(1,1) = ProdNormal_parm.getParamExactValue('Px_LDO_PowSetpoint'); 
fcp.hwo.power(1,2) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_Power_01'); 
fcp.hwo.power(1,3) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_Power_02'); 
fcp.hwo.power(1,4) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_Power_03'); 
fcp.hwo.power(1,5) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_Power_04'); 
fcp.hwo.power(1,6) = ProdNormal_parm.getParamExactValue('Px_LDO_HWO_Power_05'); 

%fcp.hwo.wind = [Px_LDO_HWO_WindSpd_RatedRef  Px_LDO_HWO_WindSpd_01  Px_LDO_HWO_WindSpd_02  Px_LDO_HWO_WindSpd_03  Px_LDO_HWO_WindSpd_04  Px_LDO_HWO_WindSpd_05];
%fcp.hwo.genSpd = [Px_LDO_GenSpdSetpoint  Px_LDO_HWO_GenSpd_01  Px_LDO_HWO_GenSpd_02  Px_LDO_HWO_GenSpd_03  Px_LDO_HWO_GenSpd_04  Px_LDO_HWO_GenSpd_05];
%fcp.hwo.power = [Px_LDO_PowSetpoint  Px_LDO_HWO_Power_01  Px_LDO_HWO_Power_02  Px_LDO_HWO_Power_03  Px_LDO_HWO_Power_04  Px_LDO_HWO_Power_05];
