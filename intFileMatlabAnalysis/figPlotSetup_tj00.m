...
f = myfigplot(101, [9 10 13 12], wantedSims, Xdata, sensorData, titleArray, ylabelArray, simNames, 1, [1000 1100], 0);
...
f = myfigplot(102, [15 16 19 18], wantedSims, Xdata, sensorData, titleArray, ylabelArray, simNames, 1, [1000 1100], 0);
figArray = [figArray f];
...
% x and y translation position and roll and pitch angle
f = myfigplot(202, [9 10], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, [0 0.1], [0 1]);
% f = myfigplot(202, [9 10 13 12], wantedSims], nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, 0, 0);
figArray = [figArray f];
figNameArray = [figNameArray strcat(setupPrefix, "xPosyPosFFT.png")];

% x and y translation position and roll and pitch angle
f = myfigplot(203, [13 12], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, [0 0.1], [0 0.05]);
% f = myfigplot(202, [9 10 13 12], wantedSims], nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, 0, 0);
...
% x and y translation velocity and roll and pitch angular velocity
% f = myfigplot(203, [15 16 19 18], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, 0, 0);
f = myfigplot(204, [15 16], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, [0 0.1], [0 0.5]);
figArray = [figArray f];
figNameArray = [figNameArray strcat(setupPrefix, "xVelyVelFFT.png")];

f = myfigplot(205, [19 18], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, [0 0.1], [0 0.01]);
figArray = [figArray f];
