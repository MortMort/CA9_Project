...
senIdx.Power = 19;
senIdx.GenMom = 21;
senIdx.Mxt17 = 39; % Tower moment (around x axis meaning in y direction)
senIdx.Mxt12 = 42; % Tower moment (around x axis meaning in y direction)
senIdx.xKF = 109;
senIdx.yKF = 110;
senIdx.zKF = 111;
senIdx.AlxKF = 112;
...
legArray(sensorIDs) = ["Vfree", "Vhub", "Pi1", "Pi2", "Pi3", "PSI", "Omega", ...
	"OmGen", "Power", "GenMom", "Mxt12", "Mxt17", "xKF", ...
...
titleArray(sensorIDs) = ["Free wind speed", "Hub wind speed", "Blade pitch angle 1", "Blade pitch angle 2", ...
	"Blade pitch angle 3", "Rotor azimuth", "Rotor angular velocity", "Generator angular velocity", ...
	"Power", "Generator torque", "Tower moment around x axis at 17 m", "Tower moment around x axis at 12 m"...
...
ylabelArray(sensorIDs) = [units.vel, units.vel, units.angDeg, units.angDeg, units.angDeg, ...
			units.angDeg, units.angVel, units.angVel, units.pow, units.T, units.Tk, units.Tk,...
			units.pos, units.pos, units.pos, ...
