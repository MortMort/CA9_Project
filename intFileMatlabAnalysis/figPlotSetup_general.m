...
f = myfigplot(100, [1 3 7 8], wantedSims, Xdata, sensorData, titleArray, ylabelArray, simNames, 1, xLimDef1, 0);
figArray = [figArray f];
figNameArray = [figNameArray strcat(setupPrefix, "VfreeToMgen.png")];


% x and y translation position and roll and pitch angle
f = myfigplot(101, [10 11 14 13], wantedSims, Xdata, sensorData, titleArray, ylabelArray, simNames, 1, xLimDef1, 0);
...
f = myfigplot(102, [16 17 20 19], wantedSims, Xdata, sensorData, titleArray, ylabelArray, simNames, 1, xLimDef1, 0);
figArray = [figArray f];
...
% x and y translation position and roll and pitch angle
f = myfigplot(202, [10 11], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, xLimFftDef1, [0 1]);
...
% x and y translation position and roll and pitch angle
f = myfigplot(203, [14 13], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, xLimFftDef1, [0 0.05]);
% f = myfigplot(202, [10 11 14 13], wantedSims], nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, 0, 0);
...
f = myfigplot(204, [16 17], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, xLimFftDef1, [0 0.5]);
figArray = [figArray f];
figNameArray = [figNameArray strcat(setupPrefix, "xVelyVelFFT.png")];

f = myfigplot(205, [20 19], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, xLimFftDef1, [0 0.01]);
figArray = [figArray f];
figNameArray = [figNameArray strcat(setupPrefix, "RollPitchAngVelFFT.png")];

% Rotor speed (Omega)
f = myfigplot(206, [7], wantedSims, nf, sensorDataFFT, titleArray, ylabelArray, simNames, 0, xLimFftDef1, [0 0.5]);
figArray = [figArray f];
