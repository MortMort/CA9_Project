...
simNames = ["ParamChange10"; 
			"ParamChange12";
			"ParamChange14"];

% Step 2: Put the folder paths to the .int files here
simFolders = [	"h:\Offshore_TEMP\USERS\MROTR\Investigations\001_DLC11_V164_8MW\001_SimFATDparamChange\Loads\INT\";
...
intFileNames = ["1110a001.int";
				"1112a001.int";
				"1114a001.int"];

% Pull the data from the .int files and store them in .mat files
...
f = myfigplot(102, [12 13 3], Nsims, Xdata, sensorData, titles, ylabels, simNames, 1);
figs = [figs f];
