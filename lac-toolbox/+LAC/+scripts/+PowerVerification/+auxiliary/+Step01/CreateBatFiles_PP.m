function CreateBatFiles_PP(Dat_Path,idx,data)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is an updated version of CreateBatFiles function in order to take
% into the normalised wind speed as input of the vts simulation
%%%
...
for i=1:length(data.dat1.filedescription)
        ...
        ,data.dat1.filename{i,1},data.dat1.mean(i,idx.WSPnorm)...
