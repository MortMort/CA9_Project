function[Meas_filtered2,Sim_filtered2] = MetMastNac_Filter10(Meas_data,Sim_data,X_sens,X_sens2,X_sens3,WTG)
...
for i = 1:length(Meas_data.data.mean(:,1))
    if 100*abs((Meas_data.data.mean(i, X_sens2) - Meas_data.data.mean(i, X_sens3)) / (Meas_data.data.mean(i, X_sens2))) < WTG.MM_Nacelle_Diff*2
