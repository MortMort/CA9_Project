...
%       - Y_sens: Sensor for the Y-axis in the plots, e.g. Electrical Thrust
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    figname1 = strcat('ThrustCoefficient.fig');
    figname2 = strcat('ThrustCoefficient.png');
...
%   1.1 - Formating
    ...
    ylabel('Thrust coefficient (-)', 'FontSize', 16);
...
%   2.5 - Reference Thrust Curve
    ...
    legend('Meas. mean', 'Sim. mean', 'location','northeast')%, 'FontSize', 12);        %legend('Meas. mean', 'Sim. mean', 'Reference C_P', 'location','northeast')%, 'FontSize', 12);    
    hold off;
...
% -------------------------------------------------------------------------
    figNo = 1;
    figure('Name', int2str(figNo), 'units', 'normalized', 'outerposition', [0 0 1 1]);
    figname1 = strcat('ThrustCoefficient_WShearfilt.fig');
    figname2 = strcat('ThrustCoefficient_WShearfilt.png');
...
%   6.5 - Reference Thrust Curve
    ...
    legend('Meas. mean', 'Sim. mean', 'location','northeast')%, 'FontSize', 14);  legend('Meas. mean', 'Sim. mean', 'Reference C_P', 'location','northeast')%, 'FontSize', 14);          
    hold off;
...
% -------------------------------------------------------------------------
    figNo = 1;
    figure('Name', int2str(figNo), 'units', 'normalized', 'outerposition', [0 0 1 1]);
    figname1 = strcat('ThrustCoefficient_WSCtrlfilt.fig');
    figname2 = strcat('ThrustCoefficient_WSCtrlfilt.png');
...
% -------------------------------------------------------------------------
    figNo = 1;
    figure('Name', int2str(figNo), 'units', 'normalized', 'outerposition', [0 0 1 1]);
    figname1 = strcat('ThrustCoefficient_WSCtrlfilt10.fig');
    figname2 = strcat('ThrustCoefficient_WSCtrlfilt10.png');
